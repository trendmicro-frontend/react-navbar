...
class Collapse extends React.Component {
    ...
    render() {
        ...
        const handleEnter =
            chainedFunction(this.handleEnter, onEnter);
        const handleEntering =
            chainedFunction(this.handleEntering, onEntering);
        const handleEntered =
            chainedFunction(this.handleEntered, onEntered);
        const handleExit =
            chainedFunction(this.handleExit, onExit);
        const handleExiting =
            chainedFunction(this.handleExiting, onExiting);
